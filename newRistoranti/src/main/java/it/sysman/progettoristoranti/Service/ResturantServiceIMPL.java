...
import it.sysman.progettoristoranti.Repository.AddressRepository;
import it.sysman.progettoristoranti.Repository.CoordinateRepository;
import it.sysman.progettoristoranti.Repository.CountryRepository;
import it.sysman.progettoristoranti.Repository.OSMInfoRepository;
...
public class ResturantServiceIMPL  implements ResturantService{
	...
	@Autowired
	private CoordinateRepository cor;
	@Autowired
	private OSMInfoRepository osr;
...
//		osr.deleteAll();
	...
	public ResturantDTO getResturantID(int addressId) {
		Optional<Address> address = Optional.of(ar.findById(addressId).get());
