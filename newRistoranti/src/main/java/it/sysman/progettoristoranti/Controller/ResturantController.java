...
public class ResturantController {
	...
	//fill the database
//	@Operation(summary = "Fill the db with all the resturant",description = "Read all the data and populate the database
//	@GetMapping("/resturants/fill")
//	public ResponseEntity<String> fill(){
//		try {
//			return new ResponseEntity<String>(service.fillDb(), HttpStatus.OK); 
//		} catch (Exception e) {
//			LOGGER.error(HttpStatus.BAD_REQUEST ,e.getCause());
